---
title: "Version control with GitHub, reproducible reporting and collaboration"
...
I use version control when working in R by setting up **repositories** on www.github.com and then **cloning** to my local computer. A **repository** is a folder containing all the files in a specified project. Using **projects** in RStudio makes it easy to sync local projects with the online version control.
...
Collaborating on writing a paper is hard. You send a file, get another one in return. Some files are on dropbox, some are lost. What if we had a system for collaborati 
